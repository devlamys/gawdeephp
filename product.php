    ...
    <div class="container ref-product-container">
        ...
        <section class="ref-product-hero" aria-labelledby="product-title">
            ...
            <div class="ref-buybox reveal">
                <h1 id="product-title" data-variant-title><?= htmlspecialchars($product['full_name']) ?> <i class="ph-fill ph-seal-check"
                ...
                <div class="ref-quantity-row">
                    ...
                    <span class="ref-stock" data-variant-stock><i></i><?= $stock > 0 ? 'In stock' : 'Out of stock' ?></span>
                </div>
        ...
        <section class="ref-product-info" id="overview">
            ...
            <div class="ref-product-info__grid">
                ...
                <!-- <a class="ref-method-card"
                    ...
                    <strong>See how it’s made</strong>
                    <span>The Gawdee Method</span>
                </a> -->
            </div>
        </section>
        ...
        <?php if (!empty($storyMedia)): ?>
            <section class="ref-watch">
                <header>
                    ...
                    <a href="reels.php?product=<?= rawurlencode($product['slug']) ?>">View All Stories &amp; Videos <i
                    ...
                    <?php foreach ($reviewCards as $review): ?>
                        <article class="ref-review-card">
                            <div class="ref-review-card__header">
                                <span
                                    class="ref-review-avatar"><?= htmlspecialchars(strtoupper(substr((string) $review['name'], 0, 1))) ?></span>
                    ...
                    <div class="product-pack reveal" data-delay="160">
                        <div class="product-pack__heading">
                            <span><?= count($variantProducts) > 1 ? 'Choose pack size' : 'Pack size' ?></span><small>Selected:
                                <?= htmlspecialchars($product['weight']) ?></small>
                        </div>
                ...
                <div class="review-list" data-review-list>
                    <?php if ($featuredReview): ?>
                        <article class="review-card reveal">
                            <div class="review-card__avatar">
                                <?= htmlspecialchars(strtoupper(substr((string) $featuredReview['name'], 0, 1))) ?>
                            </div>
                            <div>
                                <div class="review-card__top">
                                    ...
                                    <div class="review-stars"
                                        ...
                                        <?= str_repeat('★', (int) $featuredReview['rating']) ?>
                                        <?= str_repeat('☆', 5 - (int) $featuredReview['rating']) ?>
                                    </div>
                                </div>
                    ...
                    <?php foreach ($submittedReviews as $submittedReview): ?>
                        <article class="review-card">
                            <div class="review-card__avatar">
                                <?= htmlspecialchars(strtoupper(substr((string) $submittedReview['name'], 0, 1))) ?>
                            </div>
                            <div>
                                <div class="review-card__top">
                                    ...
                                    <div class="review-stars"
                                        ...
                                        <?= str_repeat('★', (int) $submittedReview['rating']) ?>
                                        <?= str_repeat('☆', 5 - (int) $submittedReview['rating']) ?>
                                    </div>
                                </div>
