...
<footer class="commerce-footer" id="site-footer">
    <div class="container commerce-footer__grid">
        ...
        <div class="commerce-footer__links"><h2>Quick Links</h2><a href="products.php">Our Products</a><a href="index.php#offers">Offers</a><a href="blog.php">Blog</a><a href="mailto:<?= htmlspecialchars(gawdee_setting('store_email', 'info@gawdee.com')) ?>">Contact Us</a></div>
        <div class="commerce-footer__links"><h2>Customer Service</h2><a href="https://gawdee.com" target="_blank" rel="noopener">Shipping Policy</a><a href="https://gawdee.com" target="_blank" rel="noopener">Return Policy</a><a href="https://gawdee.com" target="_blank" rel="noopener">Terms & Conditions</a><a href="https://gawdee.com" target="_blank" rel="noopener">Privacy Policy</a><a href="https://gawdee.com" target="_blank" rel="noopener">FAQs</a></div>
        <div class="commerce-footer__links"><h2>Categories</h2><a href="products.php?category=ghee">Ghee</a><a href="products.php?category=honey">Honey</a><a href="products.php?category=wellness">Drops</a><a href="products.php?category=nutrition">Mix Me</a><a href="products.php?category=sugar">Sugar</a></div>
        <div class="commerce-footer__signup"><h2>Stay Updated</h2><p>Subscribe to get special offers, health tips and updates.</p><form class="footer-mini-form" action="#" data-newsletter-form><label class="sr-only" for="footer-email">Email address</label><input id="footer-email" type="email" placeholder="Enter your email" required><button type="submit" aria-label="Subscribe"><i class="ph ph-paper-plane-tilt"></i></button></form></div>
    </div>
    <div class="container commerce-footer__bottom"><p>© <?= date('Y') ?> Gawdee. All rights reserved.</p><div class="payment-pills"><span>VISA</span><span>Mastercard</span><span>UPI</span><span>Paytm</span></div><p><i class="ph ph-shield-check"></i> 100% Secure Payments</p></div>
</footer>
