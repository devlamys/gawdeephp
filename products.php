...
$headerSearchValue = trim((string) ($_GET['search'] ?? ''));
...
<section class="catalog-shell section" id="product-catalog">
    <div class="container">
        <div class="catalog-toolbar">
            ...
            <label class="catalog-search"><i class="ph ph-magnifying-glass"></i><span class="sr-only">Search products</span><input type="search" value="<?= htmlspecialchars($headerSearchValue) ?>" placeholder="Search the catalogue…" data-catalog-search></label>
        </div>
